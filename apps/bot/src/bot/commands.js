...
export const COMMANDS = [
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) =>
      o
        .setName("items")
        .setDescription("Items separados por +")
        .setRequired(true),
    ),
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) =>
      o
        .setName("item")
        .setDescription("Item de referencia")
        .setRequired(true)
        .setAutocomplete(true),
    )
    .addIntegerOption((o) =>
      o
        .setName("porcentaje")
        .setDescription("Rango ±% (default 10)")
        .setMinValue(5)
        .setMaxValue(30),
    ),
  ...
  new SlashCommandBuilder()
    ...
    .addStringOption((o) =>
      o
        .setName("perk")
        .setDescription("Nombre de la perk")
        .setRequired(true)
        .setAutocomplete(true),
    ),
  ...
  new SlashCommandBuilder()
    ...
    .addIntegerOption((o) =>
      o
        .setName("ganadores")
        .setDescription("Cantidad de ganadores (default 1)")
        .setMinValue(1),
    ),
  ...
  new SlashCommandBuilder()
    ...
    .setDescription(
      "Muestra los participantes de los sorteos activos (solo administradores)",
    ),

  new SlashCommandBuilder()
    .setName("config")
    .setDescription(
      "Configura canales de precios y prefijos (solo administradores)",
    )
    .addSubcommand((s) =>
      s
        .setName("canal")
        ...
        .addStringOption((o) =>
          o
            ...
            .addChoices(
              ...
              { name: "🔵 Precio Recomendados", value: "trade" },
            ),
        ),
    )
    .addSubcommand((s) =>
...
export async function registerCommands(client) {
  ...
  for (const guild of client.guilds.cache.values()) {
    try {
      ...
      console.error(
        `⚠️ No se pudieron registrar comandos en ${guild.id}:`,
        error.message,
      );
    }
  }
